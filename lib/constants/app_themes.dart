...
class AppThemes {
  ...
  static const Color _lightPrimaryColor = Colors.deepOrangeAccent;
  static const Color _lightPrimaryVariantColor = Colors.white;
  static const Color _lightSecondaryColor = Colors.deepOrangeAccent;
  static Color _lightOnPrimaryColor = Colors.black;
  static const Color _lightButtonPrimaryColor = Colors.deepOrangeAccent;
  static const Color _lightAppBarColor = Colors.deepOrangeAccent;
  static Color _lightIconColor = Colors.deepOrangeAccent;
  static Color _lightSnackBarBackgroundErrorColor = Colors.deepOrangeAccent;
  ...
  static final TextStyle _lightScreenCaptionTextStyle = TextStyle(
      fontSize: 14.0, color: _lightAppBarColor, fontWeight: FontWeight.w100);
  ...
  static Color _darkIconColor = Colors.deepOrangeAccent;
  static Color _darkSnackBarBackgroundErrorColor = Colors.red;
  ...
  static final TextStyle _darkScreenCaptionTextStyle = TextStyle(
      fontSize: 14.0, color: _darkAppBarColor, fontWeight: FontWeight.w100);
  ...
  //the light theme
  static final ThemeData lightThemeEn = ThemeData(
    //fontFamily: null,
  ...
  static final ThemeData lightThemeAr = ThemeData(
